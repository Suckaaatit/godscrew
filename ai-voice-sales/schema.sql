...
-- ============================================================
-- TABLE 2: calls
-- Every call placed, with Vapi data attached via webhook.
-- retell_call_id stores the Vapi call_id (legacy naming preserved).
-- ============================================================
...
-- Deduplication for Vapi tool call retries.
