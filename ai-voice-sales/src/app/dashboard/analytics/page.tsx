...
import { formatDateTime, formatDuration, formatCurrencyFromCents } from "@/lib/utils";
              ...
              <tbody>
                {members.map((member) => (
                  <tr
                    ...
                    key={member.call_id}
                  >
                    <td className="px-3 py-2">{member.prospect_name}</td>
                    <td className="px-3 py-2">{member.company_name || "-"}</td>
                    ...
                    <td className="px-3 py-2">{member.duration_label}</td>
                    ...
                    selectedCategory.failed_examples.slice(0, 4).map((example) => (
                      ...
                      >
                        <p className="text-sm text-[#ffd6d6]">
                          {example.prospect_name} - {example.company_name}
                        </p>
                        <p className="mt-1 text-sm text-[#ffeaea]">&ldquo;{example.statement}&rdquo;</p>
                        <p className="mt-1 text-xs text-[#ffd6d6]">Agent response: {example.ai_response}</p>
                        <p className="mt-1 text-xs text-[#ffb0b0]">Result: {example.result}</p>
                      </div>
                    ))
                  )}
                </div>
