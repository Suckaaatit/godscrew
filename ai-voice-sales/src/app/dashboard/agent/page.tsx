...
const TOOLS = {
  send_payment_email: { args: { email: "lead@example.com" } },
  log_objection: { args: { type: "too_expensive", verbatim: "Need budget approval." } },
  schedule_followup: { args: { suggested_time: "tomorrow 2pm", reason: "Requested callback" } },
  confirm_payment: { args: {} },
  mark_do_not_call: { args: {} },
} as const;
